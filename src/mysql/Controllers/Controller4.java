...
public class Controller4 {
    ...
    public Controller4(shopView4 view4, Manage manage, DataBaseConnection dataBaseConnection, int guest_id) {
        this.view4 = view4;
        this.manage = manage;
        this.dataBaseConnection = dataBaseConnection;
        this.guest_id=guest_id;
        this.view4.addShowListener(new Controller4.SelectListener());
        this.view4.addCreateListener(new Controller4.CreateListener());
        this.view4.addCreateListener2(new Controller4.CreateListener2());
    }
