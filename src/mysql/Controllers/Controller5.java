...
public class Controller5 {
    ...
    public Controller5(shopView5 view5, Manage manage, DataBaseConnection dataBaseConnection, int cod, int guest_id, int nr) {
        ...
        this.nr = nr;// room-id
        this.view5.addShowListener(new Controller5.SelectListener());
        this.view5.addCreateListener(new Controller5.SelectListener2());
        this.view5.addCreateListener2(new Controller5.CreateListener());
        this.view5.addCreateListener3(new Controller5.CreateListener2());
    }
