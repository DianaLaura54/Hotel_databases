...
public class ChooseController {
    ...
    public ChooseController(ChooseView view2, Manage manage, DataBaseConnection dataBaseConnection, int id, int guest_id) {
        this.view2 = view2;
        this.manage = manage;
        this.dataBaseConnection = dataBaseConnection;
        this.id = id;
        this.guest_id = guest_id;
        this.view2.addShowListener(new ChooseController.SelectListener());
        this.view2.add2ShowListener(new ChooseController.SelectListener2());
        this.view2.addCreateListener(new ChooseController.CreateListener());
    }
        ...
        public void actionPerformed(ActionEvent e) {
            try {
                if (verify == 0) {
                    ...
                    view2.dispose();
                    PickView view3 = new PickView();
                    PickController controller3 = new PickController(view3, manage, dataBaseConnection, id, id_hotel, guest_id);
                }
            } catch (Exception ex) {
                view2.showMessage("Something went wrong!");
                ex.printStackTrace();
