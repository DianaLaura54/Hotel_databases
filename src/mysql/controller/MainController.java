...
public class MainController {
    ...
    public MainController(MainView view, Manage manage, DataBaseConnection dataBaseConnection) {
        this.view = view;
        this.manage = manage;
        ...
        public void actionPerformed(ActionEvent e) {
            try {
                if (ok == 1 || ok == 2) {
                    ...
                    ChooseController controller2 = new ChooseController(view2, manage, dataBaseConnection, cod, guest_id);
                } else {
        ...
        public void actionPerformed(ActionEvent e) {
            try {
                if (ok == 1) {
                    ...
                    view.dispose();
                    BookingView view4 = new BookingView();
                    BookingController controller4 = new BookingController(view4, manage, dataBaseConnection, guest_id);
                } else {
                    view.showMessage("you haven't signed in");
                }
            } catch (Exception ex) {
